  ...
  GeneratorPythia8PromptInjectedGapTriggeredDQ(int inputTriggerRatio = 5, int gentype = 0) {
    ...
    switch (gentype) {
      ...
      case 14: // generate prompt charmonia cocktail at mid rapidity at 9.6TeV
        ...
        break; 
        break;
      case 15: // generate prompt charmonia cocktail at mid rapidity at 5TeV in PbPb
        mGeneratorParam = (Generator*)GeneratorCocktailPromptCharmoniaToElectronEvtGen_PbPb5TeV(); 
        break;
      }
