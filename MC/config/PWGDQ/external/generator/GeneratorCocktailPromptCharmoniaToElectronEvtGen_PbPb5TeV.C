// usage
// o2-sim -j 4 -n 10 -g external  -o sgn  --configKeyValues "GeneratorExternal.fileName=GeneratorCocktailPromptCharmoniaToElectronEvtGen_PbPb5TeV.C;GeneratorExternal.funcName=GeneratorCocktailPromptCharmoniaToElectronEvtGen_PbPb5TeV()"
//
...
FairGenerator* GeneratorCocktailPromptCharmoniaToElectronEvtGen_PbPb5TeV()
{
  ...
  genJpsi->SetNSignalPerEvent(1);
  auto genPsi = new o2::eventgen::O2_GeneratorParamPsi;
  genPsi->SetNSignalPerEvent(1); 
  genCocktailEvtGen->AddGenerator(genJpsi, 1);
  genCocktailEvtGen->AddGenerator(genPsi, 1);
